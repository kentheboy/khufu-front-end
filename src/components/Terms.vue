                ...
                <div class="section__terms--content">
                    <div class="terms__chapter">
                        ...
                        <div class="terms__chapter--paragraph">
                            <h3 class="terms__chapter--paragraph-title">第2条 (約款の適応)</h3>
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    当社はこの約款(以下「約款」という)及び細則の定めるところにより、貸渡自動
                                    車(以下「レンタカー」という)を借受人に貸渡すものとし、借受人はこれを借受
                                    けるものとしますなお、約款及び細則に定めのない事項については、法令又は一
                                    般の習によるものとします。
                                </li>
                                <li>
                                    当社は、約款及び細則の趣旨法令及び一般の慣習に反しない範囲で特約に応ずる
                    ...
                    <div class="terms__chapter">
                        ...
                        <div class="terms__chapter--paragraph">
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    借受人は、レンタカーを借受けるにあたって、約款及び当社所定の料金表等に同意
                                    のうえ、当社所定の方法により、予め車種クラス、借受開始日時、借受場所、借受
                                    期返還場所運転者、チャイルドシート等付属品の要否、その他の借受条件(以
                                    下「借受条件」という)を明示して予約の申込を行うことがてきます。
                                </li>
                                <li>
                                    当社は、借受人から予約の申込があったときは、原則として、当社の保有するレン
                                    タカーの範囲内で予約に応ずるものとします。この場合、借受人は、当社が特に認
                                    める場合を除き、当社所定の予約申込金を支払うものとします。
                                </li>
                            </ol>
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    ...
                                    借受人か、借受人の都合により、予約した借受開始時刻を1時間以上経過してもレ
                                    ンタカー貸渡契約(以下「貸渡契約」という)の締結手続きに着手しなかったとき
                                    は、事情の如何を問わず、予約が取消されたものとします。
                                </li>
                                <li>
                                    借受人の都合により予約が取消されたときは、借受人は別に定めるところにより
                                ...
                                <li>
                                    前2項以外の事由により貸渡契約が締結されなかったときは、予約は取消されたも
                                    のとします。この場合、当社は受領済の予約申込金を受人に返還するものとします。
                                </li>
                                <li>
                                    事故、盗難、不返還、リコール、大災その他の借受人若しくは当社のいずれの責に
                                    もよらない事由により貸渡契約が締結されなかったときは、予約は取り消されたも
                                    のとします。この場合、当社は受領済の予約申込金を返還するものとします。
                                </li>
                            </ol>
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    当社及び借受人は、予約が取り消され又は貸渡契約か締結されなかったことにつ
                                    いては、第4条及び第5条に定める場合を除き、相互に何らの請求をしないものと
                                    します。
                                </li>
                            </ol>
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    借受人は、当社に代わって予約業務を取扱う旅行代理店・提携会社等(以下「代行業
                    ...
                    <div class="terms__chapter">
                        ...
                        <div class="terms__chapter--paragraph">
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                ...
                                <li>
                                    当社は、監督官庁による基本通達に基づき、貸渡簿(貸渡原票)及び第14条に規定す
                                    る貸渡証に運転者の氏名・住所運転免許の種類及び運転免許証の番号を記載し又
                                    は運転者の運転免許の写しを添付するため、貸渡契約の締結にあたり、借受人に
                                    対し、借受人の指定する運転者の運転免許証の提示を求め、当社が必要と認めた場
                                    合まその写しの提出を求めます。この場合、借受人は自己が運転者であるときは
                                    自己の運転免許証を提示し、当社が求めた場合はその写しを提出するものとし、借
                                    受人と運転者が異なるときは運転者をしてその運転者の運転免許証を提示させ、当
                                    社が求めた場合はその写しを提出させるものとします。
                                </li>
                                <li>
                                ...
                                <li>
                                    当社は、借受人又は運転者が前5項に従わない場合は貸渡契約の締結を拒絶する
                                    とともに、予約を取消すことができるものとします。なお、この場合の予約申込金
                                    等の扱いについては、第4粂第5項を適用するものとします。
                                </li>
                            </ol>
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            過去の貸渡し(他のレンタカー事業者による貸渡しを含みます。)において
                                            第18条第7項又は第24条第1項に掲げる行為があったとき。
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            当社との取引に関し、当社の従業員その他の関係者に対して暴力的行為を
                                            行い、若しくは合理的範囲を超える負担を要求し、又は暴力的行為若しくは
                                            言辞を用いたとき。
                                        </li>
                                        <li>
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    貸渡契約は、借受人が貸渡契約書に署名をし、当社が借受人にレンタカー(付属品を含む。以下同じ)を引渡したときに成立するものとします。この場合、受領済の
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                ...
                                <li>
                                    基本料金は、レンタカーの貸渡時において、各地方運輸局運輸支局長、神戸運輸監
                                    理部兵庫陸運部長又は沖縄総合事務局陸運事務所長に届け出て実施 している料金に
                                    よるものとします。
                                </li>
                                <li>
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    当社は、レンタカーを引 したときは、各地方運輸局運輸支局長、神戸輸監理部兵庫陸運部長 又は沖縄総合 事務局陸運事務所 長が定めた内容を記載した所定の貸渡 証を借受 人に交付 するものとします。
                                </li>
                                <li>
                    ...
                    <div class="terms__chapter">
                        ...
                        <div class="terms__chapter--paragraph">
                            ...
                            <p class="terms__chapter--paragraph-content">
                                借受人又は運転者は、使用中、借受けたレンタカーについて、毎日使用する前に道路運送車両法第47条の 2 (日常点検整備)に定める日常点検整備を実施しなければ
                                ならないものとします。
                            </p>
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            動車運送事業又はこれに類する目的に使用すること。 レンタカーを所定の使用目的以外に使用し又は第8 条の運転者以外の者に運転させること。
                                        </li>
                                        <li>
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                ...
                                <li>
                                    当社 は 、 察からレンタカーの放置駐車違反の連絡を受け たときは 、借受人又は運 転者に連絡し、速やかにレンタカーを移動 させ、レンタカーの借受期間満了時又は
                                    当社の指示する時ま でに取扱い響察署に出頭 して違反を処理するよう指示するもの
                                    とし、借受人又は運転者はこれに従うものとします。なお、当社は、レンタカーが警察により移動された場合には、当社の判断により、自らレンタカーを管察から引
                                    き取る場合があります。
                                </li>
                                <li>
                                    前項の場合、当社は、 借受 人又は運転者に対 し、違反処理の状況 を交通反則告知書
                                    又は納付書、領収書等により確認するものとします。確認できない場合には、放置
                                    駐車違反をした事実及び 察署等に出頭し、違反者として法律上の措置に従うこと
                                    を自認する旨の当社所定の文書(以下「自認書」といいます。)に自ら署名するよ
                                    う求めることができ、借受人又は運転者はこれに従うものとし、また当社が定める
                                ...
                                <li>
                                    ...
                                    借受人は当社に対し当社が負担した一 切の費用を賠償するものとします。なお、借受人又は運転者が、第3項に基づき駐車違反違約金を当社に 支払っている場合は、
                                    その額を限度として、放置違反金又は諸費用の賠償義務を免れるものとします。
                                </li>
                                <li>
                                    借受 人又は運転者が、第3項に基づき駐車違反達約金を当社に支払った後、借受人又は運転者が罰金又は反則金を納付し、
                                    当社にその納付書、領収書等を提示した場合、又は当社が放置違反金の還付を現実に受けたときは、
                                    当社はすみやかに受取った駐車違反違約金相当額から返金に要する費用を差引いた金額を借受人又は運転者に返還します。
                                </li>
                                <li>
                                    当社が第5項の放置違反金納付命令を受けたとき、又は借受人若しくは運転者が当社が指定する期日までに第5項の請求額を支払わないときは、当社は借受人若し
                                    くは運転者の氏名、住所、運転免許証番号等を一般社団法人全国レンタカー協会情報管理システム(以下「全レ協システム」といいます。)に登録する等の措置をと
                                    るものとします。
                                </li>
                                <li>
                    ...
                    <div class="terms__chapter">
                        ...
                        <div class="terms__chapter--paragraph">
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                ...
                                <li>
                                    借受人は、レンタカーの返還にあたって、レンタカー内に借受人、運転者又は同乗者の遺留品がないことを確認して返還するものとし、当社は、レンタカーの返還後
                                    の遺留品に ついて保管 の責を負わないもの とします。
                                </li>
                            </ol>
                            <h3 class="terms__chapter--paragraph-title">第21条 (レンタカーの返還時期等)</h3>
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    借受人は、第12条により借受期間を延長したときは、変更後の借受期間に対応する 貸渡料金、又は変更前の貸渡料金と超過料金を合計した料金のうち、いずれか低い方の料金を支払うものとします。
                                </li>
                                <li>
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    当社は、借受人に次の各号のいずれかが該当するときは、刑事告訴を行うなどの
                                    法的手続きのほか、車両位置情報システムを利用しレンタカーの所在を確認するのに必要な措置を実施するとともに一般社団法人全国レンタカー協会への不返還被害報
                                    告をする等の措置をとるものとします。
                                    <ol>
                                        <li>
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    借愛人又は運転者は、第18 条第7項又は第24条第1項のいずれかに該当すること
                                    となった場合は、当該事実及び借受人又は運転者の氏名、住所等を含む情報が、全レ協システムに7年を超えない期間登録されること並びにその情報が 一般社団法人
                                    全国レンタカー協会及びこれに加盟する各地区レンタカー協会並びにこれらの会員
                                    であるレンタカー事業者によって貸渡契約締結の際の審査のために利用されることに同意するものとします。
                                </li>
                            </ol>
                        </div>
                    </div>
                    <div class="terms__chapter">
                        ...
                        <div class="terms__chapter--paragraph">
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            事故に関し相手方と示談その他の合意をするときは、予め当社の承諾 を受けること。
                                        </li>
                                    </ol>
                                </li>
                                <li>
                            ...
                            <p class="terms__chapter--paragraph-content">
                                借受人又は運転者は、使用中に レンタカーの盗難が発生したときその他被害を受け たときは、次に定める措置をとるものとします。
                            </p>
                            <ol class="terms__chapter--paragraph-content">
                                <ol>
                                    <li>
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                ...
                                <li>
                                    故障等が貸渡前に存した瑕疵による場合は、借受人は当社から代替レンタカーの提供を受けることができるものとします。なお、代替レンタカーの提供条件については、第5 条を準用するものとします。
                                </li>
                                <li>
                    ...
                    <div class="terms__chapter">
                        ...
                        <div class="terms__chapter--paragraph">
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                ...
                                <li>
                                    前項の当社の損害のうち、事故、盗難、借受人又は運転者の責に帰すべき事由によ
                                    る故障、レンタカーの汚損・臭気等により当社がそのレンタカーを利用できないこ
                                    とによる損害についても、借受人はこれを賠償するものとします。
                                </li>
                                <li>
                                    前各項にかかわらず、激甚災害に対処するための特別の財政措置等に関する法律(昭和37年法律第150号)第2条に基づき数を災害と指定された災害(以下「激甚災
                                    害」という)による損害については、その損害が当該激甚災害に指定された地域において不可抗力により滅失し、き損し、
                                    又はそ の他の被害を受 けたレンタカー に係 るものである場合には、借受人又は運転者は、その損害を賠償 することを要しない
                                    ものとします。
                                </li>
                            </ol>
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    借受人又は運転者が約款及び細則に基づく賠償責任を負うときは、 当社がレンタカ
                                    ーについて締結した損害保険契約により、次の限度内の保険金が給付されます。但し、 その保険約款の 免責事由に該当するときはこの保険金は給付されません。
                                    <ol>
                                        <li>対人補償1名につき無制限(自賠責保険を含む)</li>
                                        <li>対物補償1事故につき無制限(資額5万円)</li>
                                        <li>車両補償 1事故につき時価まで(免責額5万円 但し、バス・大型貨
                                            物車 10 万円)</li>
                                        <li>人身傷害補償1名につき2,000万円まで</li>
                                    </ol>
                                </li>
                                <li>
                                    保険金が給付されない損害及び前項の定めにより給付 される保険金額を超える損害
                    ...
                    <div class="terms__chapter">
                        ...
                        <div class="terms__chapter--paragraph">
                            ...
                            <p class="terms__chapter--paragraph-content">
                                当社は、借受人又は運転者が借受期間 中に約款及び細則に違反したときは、何らの
                                通知・催告を要せず貸渡契約を解除し、直ちにレンタカーの返還を請求することができるものとします。この場合、当社は受領済の貸渡料金を借受人に返還しないも
                                のとします。
                            </p>
                            <h3 class="terms__chapter--paragraph-title">第33条 (同意解約)</h3>
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    借受人は、借受期間中であっても、当社の同意を得て貸渡契約を解約することができるものとします。この場合、当社は、受領済の貸渡料金から、
                                    貸渡から返還までの期間に対応する貸渡料金を差し引いた残額を借受人に返還するものとします。
                                </li>
                                <li>
                    ...
                    <div class="terms__chapter">
                        ...
                        <div class="terms__chapter--paragraph">
                            ...
                            <ol class="terms__chapter--paragraph-content">
                               <li>
                                    当社が借受 人又は運転者 の個 人情報 を取 得し、 利用 する目的は次 の とおりです。
                                    <ol>
                                        <li>
                    ...
                    <div class="terms__chapter">
                        ...
                        <div class="terms__chapter--paragraph">
                            ...
                            <ol class="terms__chapter--paragraph-content">
                                <li>
                                    当社は、 予告なく約款及び細則を改訂 し、 又は約款の細則を別に定めることができ
                                    るものとします。
                                </li>
                                <li>
                            ...
                            <p class="terms__chapter--paragraph-content">
                                この約款及び細則に基づく権利及び義務について紛争が生じたときは、当社の本店
